...
class DTInstOutputs(object):
    def __init__(
        ...
        self.proposal_matcher = Matcher(
            cfg.MODEL.DTInst.IOU_THRESHOLDS,
            cfg.MODEL.DTInst.IOU_LABELS,
    ...
    def DTInst_losses(
        ...
        if self.loss_on_code:
            ...
            if 'kurtosis' in self.mask_loss_type or 'variance' in self.mask_loss_type:
                ...
                mask_pred_m2 = torch.var(mask_pred, dim=1, keepdim=True) + 1e-5
    ...
    def losses(self):
        """
        Return the losses from a set of DTInst predictions and their associated ground-truth.
