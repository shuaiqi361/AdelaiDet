...
class SMUPInstOutputs(object):
    def __init__(
        ...
        self.loss_on_mask = cfg.MODEL.SMUPInst.LOSS_ON_MASK
        ...
        self.proposal_matcher = Matcher(
            cfg.MODEL.SMUPInst.IOU_THRESHOLDS,
            cfg.MODEL.SMUPInst.IOU_LABELS,
    ...
    def SMUPInst_losses(
        ...
        losses = {
            "loss_SMUPInst_cls": class_loss,
            "loss_SMUPInst_loc": reg_loss,
            "loss_SMUPInst_ctr": ctrness_loss,
            "loss_SMUPInst_mask": total_mask_loss,
        }
        return losses, {}

    def losses(self):
        """
        Return the losses from a set of SMUPInst predictions and their associated ground-truth.
